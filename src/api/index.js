...
import ErshoushangchengController from './Ershoushangcheng'
import MaijiazixunController from './Maijiazixun'
...
import DiscussershoushangchengController from './Discussershoushangcheng'
...
export default ({ config, db }) => {
	...
	api.use('/ershoushangcheng', ErshoushangchengController({ config, db }))

	api.use('/maijiazixun', MaijiazixunController({ config, db }))
	...
	api.use('/discussershoushangcheng', DiscussershoushangchengController({ config, db }))

<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="咨询编号" prop="zixunbianhao">
					<el-input v-model="ruleForm.zixunbianhao" placeholder="咨询编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.zixunbianhao" label="咨询编号" prop="zixunbianhao">
					<el-input v-model="ruleForm.zixunbianhao" placeholder="咨询编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="咨询标题" prop="zixunbiaoti">
					<el-input v-model="ruleForm.zixunbiaoti" placeholder="咨询标题" clearable  :readonly="ro.zixunbiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="咨询标题" prop="zixunbiaoti">
					<el-input v-model="ruleForm.zixunbiaoti" placeholder="咨询标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="咨询时间" prop="zixunshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.zixunshijian" label="咨询时间" prop="zixunshijian">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="买家账号" prop="maijiazhanghao">
					<el-input v-model="ruleForm.maijiazhanghao" placeholder="买家账号" clearable  :readonly="ro.maijiazhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="买家账号" prop="maijiazhanghao">
					<el-input v-model="ruleForm.maijiazhanghao" placeholder="买家账号" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="咨询内容" prop="zixunneirong">
					<editor 
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.zixunneirong" label="咨询内容" prop="zixunneirong">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zixunneirong = this.ruleForm.zixunneirong.replace(reg,'../../../nodejs2ht5t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `maijiazixun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.maijiazixunCrossAddOrUpdateFlag = false;
						 this.parent.search();

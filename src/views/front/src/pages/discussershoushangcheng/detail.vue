...
<script>
  ...
  export default {
    ...
    data() {
      return {
        tablename: 'discussershoushangcheng',
        baseUrl: '',
        breadcrumbItem: [
          {
            name: '详情信息'
    ...
    methods: {
      ...
      getDiscussList(page) {
        this.$http.get('discussdiscussershoushangcheng/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussdiscussershoushangcheng/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
                this.getDiscussList(1);
                this.$message({
